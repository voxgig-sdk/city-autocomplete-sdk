...
// CityAutocomplete SDK netsim feature
...
class CityAutocompleteNetsimFeature extends CityAutocompleteBaseFeature
{
    ...
    private function _simulate(CityAutocompleteContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CityAutocompleteContext $ctx, array $applied): void
    {
        $client = $this->client;
