...
// CityAutocomplete SDK audit feature
...
class CityAutocompleteAuditFeature extends CityAutocompleteBaseFeature
{
    ...
    private function _emit(CityAutocompleteContext $ctx, string $outcome): void
    {
