...
// CityAutocomplete SDK proxy feature
...
class CityAutocompleteProxyFeature extends CityAutocompleteBaseFeature
{
    ...
    public function init(CityAutocompleteContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CityAutocompleteContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
