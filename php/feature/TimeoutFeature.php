...
// CityAutocomplete SDK timeout feature
...
class CityAutocompleteTimeoutFeature extends CityAutocompleteBaseFeature
{
    ...
    private function _with_timeout(CityAutocompleteContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CityAutocompleteContext $_ctx, float $ms): void
    {
        $client = $this->client;
