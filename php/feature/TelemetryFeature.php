...
// CityAutocomplete SDK telemetry feature
...
class CityAutocompleteTelemetryFeature extends CityAutocompleteBaseFeature
{
    ...
    private function _close(CityAutocompleteContext $ctx, bool $ok): void
    {
