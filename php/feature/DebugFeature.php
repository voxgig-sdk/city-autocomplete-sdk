...
// CityAutocomplete SDK debug feature
...
class CityAutocompleteDebugFeature extends CityAutocompleteBaseFeature
{
    ...
    private function _finish(CityAutocompleteContext $ctx, bool $ok): void
    {
