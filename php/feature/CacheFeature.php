...
// CityAutocomplete SDK cache feature
...
class CityAutocompleteCacheFeature extends CityAutocompleteBaseFeature
{
    ...
    private function _through(CityAutocompleteContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
