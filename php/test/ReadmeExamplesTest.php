...
// CityAutocomplete SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CityAutocompleteSDK::test)
...
{
    private const SDK_CLASS = 'CityAutocompleteSDK';
    ...
    private const SDK_BASE = 'cityautocomplete_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../cityautocomplete_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
