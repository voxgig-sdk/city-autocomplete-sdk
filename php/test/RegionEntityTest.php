...
class RegionEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set CITY_AUTOCOMPLETE_TEST_REGION_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function region_basic_setup($extra)
{
    ...
    // Generate idmap.
    $idmap = [];
    foreach (["region01", "region02", "region03", "country01", "country02", "country03"] as $k) {
    ...
    $entid_env_raw = getenv("CITY_AUTOCOMPLETE_TEST_REGION_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["CITY_AUTOCOMPLETE_TEST_REGION_ENTID"]);
