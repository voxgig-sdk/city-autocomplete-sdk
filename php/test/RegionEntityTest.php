...
class RegionEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set CITYAUTOCOMPLETE_TEST_REGION_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function region_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("CITYAUTOCOMPLETE_TEST_REGION_ENTID");
    $idmap_overridden = $entid_env_raw !== false && str_starts_with(trim($entid_env_raw), "{");

    $env = Runner::env_override([
        "CITYAUTOCOMPLETE_TEST_REGION_ENTID" => $idmap,
    ...
    $idmap_resolved = Helpers::to_map(
        $env["CITYAUTOCOMPLETE_TEST_REGION_ENTID"]);
