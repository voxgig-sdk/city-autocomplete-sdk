...
class DistanceDirectTest extends TestCase
{
    public function test_direct_load_distance(): void
    {
        $setup = distance_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-distance", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
