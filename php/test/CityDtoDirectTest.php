...
class CityDtoDirectTest extends TestCase
{
    public function test_direct_list_city_dto(): void
    {
        $setup = city_dto_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-city_dto", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
