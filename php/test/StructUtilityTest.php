...
// CityAutocomplete SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CityAutocompleteOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CityAutocompleteOmni::structfix($now, Struct::undef()))
                        !== json_encode(CityAutocompleteOmni::structfix($val, Struct::undef()))) {
