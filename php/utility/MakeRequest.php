...
// CityAutocomplete SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class CityAutocompleteMakeRequest
{
    public static function call(CityAutocompleteContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new CityAutocompleteResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new CityAutocompleteResponse($fetched);
        } else {
