...
// CityAutocomplete SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class CityAutocompleteTransformResponse
{
    public static function call(CityAutocompleteContext $ctx): mixed
    {
        ...
        $transform = CityAutocompleteHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
