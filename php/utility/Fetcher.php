...
// CityAutocomplete SDK utility: fetcher

class CityAutocompleteFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CityAutocompleteSDK/1.0)';
    ...
    public static function call(CityAutocompleteContext $ctx, string $fullurl, array $fetchdef): array
    {
