...
// CityAutocomplete SDK RegionTranslationDto entity
...
class RegionTranslationDtoEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "region_translation_dto";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new RegionTranslationDtoEntity($this->_client, $opts);
    }

    /**
     * @param RegionTranslationDto|array $args RegionTranslationDto data (assoc-array) to store.
     */
    ...
    /**
     * @return RegionTranslationDto|array The current RegionTranslationDto data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RegionTranslationDto fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RegionTranslationDto fields).
     */
    ...
    /**
     * List RegionTranslationDto items matching the given filter.
     *
     * @param RegionTranslationDtoListMatch|array|null $reqmatch Match filter (any subset
     *   of RegionTranslationDto fields) as an assoc-array; RegionTranslationDtoListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RegionTranslationDto[]|array A list of RegionTranslationDto items as assoc-arrays at
