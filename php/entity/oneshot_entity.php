...
// CityAutocomplete SDK Oneshot entity
...
class OneshotEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OneshotEntity($this->_client, $opts);
    }

    /**
     * @param Oneshot|array $args Oneshot data (assoc-array) to store.
     */
    ...
    /**
     * @return Oneshot|array The current Oneshot data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Oneshot fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Oneshot fields).
     */
    ...
    /**
     * List Oneshot items matching the given filter.
     *
     * @param OneshotListMatch|array|null $reqmatch Match filter (any subset
     *   of Oneshot fields) as an assoc-array; OneshotListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Oneshot[]|array A list of Oneshot items as assoc-arrays at
