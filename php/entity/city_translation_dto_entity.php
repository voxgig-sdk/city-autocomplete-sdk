...
// CityAutocomplete SDK CityTranslationDto entity
...
class CityTranslationDtoEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "city_translation_dto";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CityTranslationDtoEntity($this->_client, $opts);
    }

    /**
     * @param CityTranslationDto|array $args CityTranslationDto data (assoc-array) to store.
     */
    ...
    /**
     * @return CityTranslationDto|array The current CityTranslationDto data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CityTranslationDto fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CityTranslationDto fields).
     */
    ...
    /**
     * List CityTranslationDto items matching the given filter.
     *
     * @param CityTranslationDtoListMatch|array|null $reqmatch Match filter (any subset
     *   of CityTranslationDto fields) as an assoc-array; CityTranslationDtoListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CityTranslationDto[]|array A list of CityTranslationDto items as assoc-arrays at
