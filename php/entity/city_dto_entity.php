...
// CityAutocomplete SDK CityDto entity
...
class CityDtoEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CityDtoEntity($this->_client, $opts);
    }

    /**
     * @param CityDto|array $args CityDto data (assoc-array) to store.
     */
    ...
    /**
     * @return CityDto|array The current CityDto data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CityDto fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CityDto fields).
     */
    ...
    /**
     * List CityDto items matching the given filter.
     *
     * @param CityDtoListMatch|array|null $reqmatch Match filter (any subset
     *   of CityDto fields) as an assoc-array; CityDtoListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CityDto[]|array A list of CityDto items as assoc-arrays at
