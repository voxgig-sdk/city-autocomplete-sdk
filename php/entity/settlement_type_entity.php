...
// CityAutocomplete SDK SettlementType entity
...
class SettlementTypeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SettlementTypeEntity($this->_client, $opts);
    }

    /**
     * @param SettlementType|array $args SettlementType data (assoc-array) to store.
     */
    ...
    /**
     * @return SettlementType|array The current SettlementType data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SettlementType fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SettlementType fields).
     */
    ...
    /**
     * List SettlementType items matching the given filter.
     *
     * @param SettlementTypeListMatch|array|null $reqmatch Match filter (any subset
     *   of SettlementType fields) as an assoc-array; SettlementTypeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SettlementType[]|array A list of SettlementType items as assoc-arrays at
