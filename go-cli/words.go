...
func registerSDKWords(r *eng.Registry, client *sdk.CityAutocompleteSDK) {
...
func runOp(client *sdk.CityAutocompleteSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
