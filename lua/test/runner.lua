...
function runner.env_override(m)
  local live = runner.getenv("CITYAUTOCOMPLETE_TEST_LIVE")
  local override = runner.getenv("CITYAUTOCOMPLETE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CITYAUTOCOMPLETE_TEST_EXPLAIN")
