...
function runner.env_override(m)
  local live = runner.getenv("CITY_AUTOCOMPLETE_TEST_LIVE")
  local override = runner.getenv("CITY_AUTOCOMPLETE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CITY_AUTOCOMPLETE_TEST_EXPLAIN")
