...
describe("CityDtoDirect", function()
  it("should direct-list-city_dto", function()
    local setup = city_dto_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-city_dto", setup.live and "live" or "unit")
...
function city_dto_direct_setup(mockres)
