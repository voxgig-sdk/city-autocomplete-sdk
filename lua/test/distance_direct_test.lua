...
describe("DistanceDirect", function()
  it("should direct-load-distance", function()
    local setup = distance_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-distance", setup.live and "live" or "unit")
...
function distance_direct_setup(mockres)
