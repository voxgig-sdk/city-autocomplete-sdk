...
local SettlementTypeEntity = {}
SettlementTypeEntity.__index = SettlementTypeEntity


function SettlementTypeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SettlementTypeEntity)
  self._name = "settlement_type"
  self._client = client
...
function SettlementTypeEntity:get_name()
  return self._name
end


function SettlementTypeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SettlementTypeEntity.new(self._client, opts)
end
...
function SettlementTypeEntity:mark_deleted()
  self._deleted = true
end


function SettlementTypeEntity:deleted()
  return true == self._deleted
end


function SettlementTypeEntity:data_set(args)
  if args ~= nil then
...
function SettlementTypeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SettlementTypeEntity:match_set(args)
  if args ~= nil then
...
function SettlementTypeEntity:match_get()
...
function SettlementTypeEntity:stream(action, args, callopts)
...
---@param reqmatch SettlementTypeListMatch
---@param ctrl? table
---@return SettlementType[]
---@return string? err
function SettlementTypeEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function SettlementTypeEntity:_run_op(ctx, post_done)
  local utility = self._utility
