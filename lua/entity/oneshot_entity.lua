...
local OneshotEntity = {}
OneshotEntity.__index = OneshotEntity


function OneshotEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OneshotEntity)
  self._name = "oneshot"
  self._client = client
...
function OneshotEntity:get_name()
  return self._name
end


function OneshotEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OneshotEntity.new(self._client, opts)
end
...
function OneshotEntity:mark_deleted()
  self._deleted = true
end


function OneshotEntity:deleted()
  return true == self._deleted
end


function OneshotEntity:data_set(args)
  if args ~= nil then
...
function OneshotEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OneshotEntity:match_set(args)
  if args ~= nil then
...
function OneshotEntity:match_get()
...
function OneshotEntity:stream(action, args, callopts)
...
---@param reqmatch OneshotListMatch
---@param ctrl? table
---@return Oneshot[]
---@return string? err
function OneshotEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function OneshotEntity:_run_op(ctx, post_done)
  local utility = self._utility
