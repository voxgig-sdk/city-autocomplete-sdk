...
local CountryTranslationDtoEntity = {}
CountryTranslationDtoEntity.__index = CountryTranslationDtoEntity


function CountryTranslationDtoEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CountryTranslationDtoEntity)
  self._name = "country_translation_dto"
  self._client = client
...
function CountryTranslationDtoEntity:get_name()
  return self._name
end


function CountryTranslationDtoEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CountryTranslationDtoEntity.new(self._client, opts)
end
...
function CountryTranslationDtoEntity:mark_deleted()
  self._deleted = true
end


function CountryTranslationDtoEntity:deleted()
  return true == self._deleted
end


function CountryTranslationDtoEntity:data_set(args)
  if args ~= nil then
...
function CountryTranslationDtoEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CountryTranslationDtoEntity:match_set(args)
  if args ~= nil then
...
function CountryTranslationDtoEntity:match_get()
...
function CountryTranslationDtoEntity:stream(action, args, callopts)
...
---@param reqmatch CountryTranslationDtoListMatch
---@param ctrl? table
---@return CountryTranslationDto[]
---@return string? err
function CountryTranslationDtoEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function CountryTranslationDtoEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CountryTranslationDtoEntity
