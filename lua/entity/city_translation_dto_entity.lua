...
local CityTranslationDtoEntity = {}
CityTranslationDtoEntity.__index = CityTranslationDtoEntity


function CityTranslationDtoEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CityTranslationDtoEntity)
  self._name = "city_translation_dto"
  self._client = client
...
function CityTranslationDtoEntity:get_name()
  return self._name
end


function CityTranslationDtoEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CityTranslationDtoEntity.new(self._client, opts)
end
...
function CityTranslationDtoEntity:mark_deleted()
  self._deleted = true
end


function CityTranslationDtoEntity:deleted()
  return true == self._deleted
end


function CityTranslationDtoEntity:data_set(args)
  if args ~= nil then
...
function CityTranslationDtoEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CityTranslationDtoEntity:match_set(args)
  if args ~= nil then
...
function CityTranslationDtoEntity:match_get()
...
function CityTranslationDtoEntity:stream(action, args, callopts)
...
---@param reqmatch CityTranslationDtoListMatch
---@param ctrl? table
---@return CityTranslationDto[]
---@return string? err
function CityTranslationDtoEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function CityTranslationDtoEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CityTranslationDtoEntity
