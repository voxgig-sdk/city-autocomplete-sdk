...
local RegionTranslationDtoEntity = {}
RegionTranslationDtoEntity.__index = RegionTranslationDtoEntity


function RegionTranslationDtoEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RegionTranslationDtoEntity)
  self._name = "region_translation_dto"
  self._client = client
...
function RegionTranslationDtoEntity:get_name()
  return self._name
end


function RegionTranslationDtoEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RegionTranslationDtoEntity.new(self._client, opts)
end
...
function RegionTranslationDtoEntity:mark_deleted()
  self._deleted = true
end


function RegionTranslationDtoEntity:deleted()
  return true == self._deleted
end


function RegionTranslationDtoEntity:data_set(args)
  if args ~= nil then
...
function RegionTranslationDtoEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RegionTranslationDtoEntity:match_set(args)
  if args ~= nil then
...
function RegionTranslationDtoEntity:match_get()
...
function RegionTranslationDtoEntity:stream(action, args, callopts)
...
---@param reqmatch RegionTranslationDtoListMatch
---@param ctrl? table
---@return RegionTranslationDto[]
---@return string? err
function RegionTranslationDtoEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function RegionTranslationDtoEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return RegionTranslationDtoEntity
