...
#      offline in seeded test mode (CityAutocompleteSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "CityAutocomplete_sdk.rb")
  SDK_CLASS = "CityAutocompleteSDK"
