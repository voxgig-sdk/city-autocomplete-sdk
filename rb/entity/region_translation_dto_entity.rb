...
class RegionTranslationDtoEntity
  ...
  def make
    opts = @_entopts.dup
    RegionTranslationDtoEntity.new(@_client, opts)
  end
  ...
  # @return [RegionTranslationDto, Hash] the current RegionTranslationDto data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of RegionTranslationDto fields)
  def match_get
  ...
  #
  # @param reqmatch [RegionTranslationDtoListMatch, Hash, nil] match filter (any subset of
  #   RegionTranslationDto fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<RegionTranslationDto>, Array] the matching RegionTranslationDto items; raises CityAutocompleteError on failure
