# CityAutocomplete SDK Region entity
...
class RegionEntity
  ...
  # @return [Region, Hash] the loaded Region; raises CityAutocompleteError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Region>, Array] the matching Region items; raises CityAutocompleteError on failure
