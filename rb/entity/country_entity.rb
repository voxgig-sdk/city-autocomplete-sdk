# CityAutocomplete SDK Country entity
...
class CountryEntity
  ...
  # @return [Country, Hash] the loaded Country; raises CityAutocompleteError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Country>, Array] the matching Country items; raises CityAutocompleteError on failure
