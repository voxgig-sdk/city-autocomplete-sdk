...
class CityTranslationDtoEntity
  ...
  def make
    opts = @_entopts.dup
    CityTranslationDtoEntity.new(@_client, opts)
  end
  ...
  # @return [CityTranslationDto, Hash] the current CityTranslationDto data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CityTranslationDto fields)
  def match_get
  ...
  #
  # @param reqmatch [CityTranslationDtoListMatch, Hash, nil] match filter (any subset of
  #   CityTranslationDto fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<CityTranslationDto>, Array] the matching CityTranslationDto items; raises CityAutocompleteError on failure
