...
class OneshotEntity
  ...
  def make
    opts = @_entopts.dup
    OneshotEntity.new(@_client, opts)
  end
  ...
  # @return [Oneshot, Hash] the current Oneshot data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Oneshot fields)
  def match_get
  ...
  #
  # @param reqmatch [OneshotListMatch, Hash, nil] match filter (any subset of
  #   Oneshot fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Oneshot>, Array] the matching Oneshot items; raises CityAutocompleteError on failure
