...
class CityDtoEntity
  ...
  def make
    opts = @_entopts.dup
    CityDtoEntity.new(@_client, opts)
  end
  ...
  # @return [CityDto, Hash] the current CityDto data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CityDto fields)
  def match_get
  ...
  #
  # @param reqmatch [CityDtoListMatch, Hash, nil] match filter (any subset of
  #   CityDto fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<CityDto>, Array] the matching CityDto items; raises CityAutocompleteError on failure
