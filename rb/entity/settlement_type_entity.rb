...
class SettlementTypeEntity
  ...
  def make
    opts = @_entopts.dup
    SettlementTypeEntity.new(@_client, opts)
  end
  ...
  # @return [SettlementType, Hash] the current SettlementType data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of SettlementType fields)
  def match_get
  ...
  #
  # @param reqmatch [SettlementTypeListMatch, Hash, nil] match filter (any subset of
  #   SettlementType fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<SettlementType>, Array] the matching SettlementType items; raises CityAutocompleteError on failure
