# CityAutocomplete SDK Language entity
...
class LanguageEntity
  ...
  # @return [Language, Hash] the loaded Language; raises CityAutocompleteError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Language>, Array] the matching Language items; raises CityAutocompleteError on failure
