...
from projectname_sdk.core.control import CityAutocompleteControl
...
class CityAutocompleteContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = CityAutocompleteControl()
        ...
        if isinstance(sp, CityAutocompleteSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, CityAutocompleteResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, CityAutocompleteResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return CityAutocompleteOperation({})
    ...
    def make_error(self, code, msg):
        return CityAutocompleteError(code, msg, self)
