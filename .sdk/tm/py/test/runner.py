...
class CityAutocompleteTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CityAutocompleteTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = CityAutocompleteTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = CityAutocompleteTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
