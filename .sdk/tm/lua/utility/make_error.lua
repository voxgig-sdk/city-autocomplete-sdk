...
local function make_error_util(ctx, err)
  ...
  local msg = "CityAutocompleteSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = CityAutocompleteError.new("", msg, ctx)
  sdk_err.result = ctx.utility.clean(ctx, result)
  sdk_err.spec = ctx.utility.clean(ctx, spec)

  if type(err) == "table" and getmetatable(err) == CityAutocompleteError then
