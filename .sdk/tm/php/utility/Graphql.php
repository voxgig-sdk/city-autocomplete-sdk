...
// CityAutocomplete SDK utility: graphql
//
...
class CityAutocompleteGraphql
{
    ...
    // equivalent.
    public static function body(CityAutocompleteContext $ctx): mixed
    {
    ...
    public static function errors(CityAutocompleteContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
