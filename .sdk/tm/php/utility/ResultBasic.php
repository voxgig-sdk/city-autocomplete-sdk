...
// CityAutocomplete SDK utility: result_basic

class CityAutocompleteResultBasic
{
    public static function call(CityAutocompleteContext $ctx): ?CityAutocompleteResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof CityAutocompleteError) ? $result->err->msg : (string)$result->err;
