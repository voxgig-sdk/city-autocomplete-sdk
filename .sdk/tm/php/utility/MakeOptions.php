...
// CityAutocomplete SDK utility: make_options

class CityAutocompleteMakeOptions
{
    ...
    public static function call(CityAutocompleteContext $ctx): array
    {
        ...
        //
        // `CityAutocompleteSchema::optspec()` is built from the model:
        ...
        $optspec = CityAutocompleteSchema::optspec();
