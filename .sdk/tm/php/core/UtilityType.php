...
// CityAutocomplete SDK utility type

class CityAutocompleteUtility
{
    ...
    public static function copy(CityAutocompleteUtility $src): CityAutocompleteUtility
    {
        $u = new CityAutocompleteUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
