...
// CityAutocomplete SDK ratelimit feature
...
class CityAutocompleteRatelimitFeature extends CityAutocompleteBaseFeature
{
    ...
    private function _acquire(CityAutocompleteContext $ctx): void
    {
    ...
    private function _track(CityAutocompleteContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
