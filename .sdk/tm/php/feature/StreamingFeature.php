...
// CityAutocomplete SDK streaming feature
...
class CityAutocompleteStreamingFeature extends CityAutocompleteBaseFeature
{
    ...
    private function _iterate(CityAutocompleteResult $result): \Generator
    {
    ...
    private function _streamable(CityAutocompleteContext $ctx): bool
    {
