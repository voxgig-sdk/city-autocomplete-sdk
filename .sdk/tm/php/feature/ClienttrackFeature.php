...
// CityAutocomplete SDK clienttrack feature
...
class CityAutocompleteClienttrackFeature extends CityAutocompleteBaseFeature
{
    ...
    public function PostConstruct(CityAutocompleteContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'CityAutocomplete-SDK';
