...
// CityAutocomplete SDK rbac feature
...
class CityAutocompleteRbacFeature extends CityAutocompleteBaseFeature
{
    ...
    private function _required(CityAutocompleteContext $ctx): ?string
    {
    ...
    private function _reject(CityAutocompleteContext $ctx, string $required): void
    {
    ...
    private function _track(CityAutocompleteContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
