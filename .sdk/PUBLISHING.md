...
|---|---|---|
| `ts/` | @voxgig-sdk/city-autocomplete-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/city-autocomplete-sdk \
      --repository voxgig-sdk/city-autocomplete-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/city-autocomplete-sdk` shows it, and
`npm trust revoke @voxgig-sdk/city-autocomplete-sdk --id=<id>` removes it.
