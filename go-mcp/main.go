// Command CityAutocomplete-mcp is an MCP server exposing the CityAutocomplete
// SDK as MCP tools.
//
// Two tools are registered:
//
//	CityAutocomplete_list  — list records of an entity
//	CityAutocomplete_load  — load a single record of an entity
//
