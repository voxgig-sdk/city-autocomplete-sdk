...
class SettlementTypeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SettlementTypeEntity(self._client, opts)
    ...
    def data_get(self) -> SettlementType:
    ...
    def match_get(self) -> SettlementType:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[SettlementType]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.SettlementType().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
