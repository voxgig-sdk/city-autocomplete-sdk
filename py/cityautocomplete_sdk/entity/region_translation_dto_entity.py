...
class RegionTranslationDtoEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RegionTranslationDtoEntity(self._client, opts)
    ...
    def data_get(self) -> RegionTranslationDto:
    ...
    def match_get(self) -> RegionTranslationDto:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[RegionTranslationDto]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.RegionTranslationDto().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
