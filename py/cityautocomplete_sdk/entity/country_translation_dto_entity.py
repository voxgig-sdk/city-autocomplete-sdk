...
from cityautocomplete_sdk.cityautocomplete_types import (
...
class CountryTranslationDtoEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CountryTranslationDtoEntity(self._client, opts)
    ...
    def data_get(self) -> CountryTranslationDto:
    ...
    def match_get(self) -> CountryTranslationDto:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CountryTranslationDto]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CountryTranslationDto().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
