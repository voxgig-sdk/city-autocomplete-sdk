...
class CityTranslationDtoEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CityTranslationDtoEntity(self._client, opts)
    ...
    def data_get(self) -> CityTranslationDto:
    ...
    def match_get(self) -> CityTranslationDto:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CityTranslationDto]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CityTranslationDto().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
