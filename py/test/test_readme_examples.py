# CityAutocomplete SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CityAutocompleteSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CityAutocompleteSDK(...) and CityAutocompleteSDK.test(...) become
#      CityAutocompleteSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "cityautocomplete_sdk"
_SDK_CLASS = "CityAutocompleteSDK"
...
_ENTITIES = {
    "City": "city",
    "CityDto": "city_dto",
    "CityTranslationDto": "city_translation_dto",
    "Country": "country",
    "CountryTranslationDto": "country_translation_dto",
    "Distance": "distance",
    "Language": "language",
    "Oneshot": "oneshot",
    "Region": "region",
    "RegionTranslationDto": "region_translation_dto",
