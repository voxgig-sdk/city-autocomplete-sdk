...
(0, node_test_1.describe)('OneshotDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-oneshot', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-oneshot', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["city_name01", "country01", "language01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CITY_AUTOCOMPLETE_TEST_ONESHOT_ENTID'];
...
//# sourceMappingURL=OneshotDirect.test.js.map