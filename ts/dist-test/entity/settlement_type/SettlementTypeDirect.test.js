...
(0, node_test_1.describe)('SettlementTypeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-settlement_type', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-settlement_type', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["city01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CITY_AUTOCOMPLETE_TEST_SETTLEMENT_TYPE_ENTID'];
...
//# sourceMappingURL=SettlementTypeDirect.test.js.map