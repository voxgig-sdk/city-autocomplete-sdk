...
(0, node_test_1.describe)('CityDtoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-city_dto', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-city_dto', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CITY_AUTOCOMPLETE_TEST_CITY_DTO_ENTID'];
...
//# sourceMappingURL=CityDtoDirect.test.js.map