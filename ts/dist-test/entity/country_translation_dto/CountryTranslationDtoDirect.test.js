...
(0, node_test_1.describe)('CountryTranslationDtoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.CityAutocompleteSDK({
    ...
    (0, node_test_1.test)('direct-list-country_translation_dto', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-country_translation_dto', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["country_translation_dto01"]))
            return;
...
function liveScenariosActive() { return false && process.env.CITY_AUTOCOMPLETE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.CityAutocompleteSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.CITY_AUTOCOMPLETE_APIKEY,
        }));
        let idmap = env['CITY_AUTOCOMPLETE_TEST_COUNTRY_TRANSLATION_DTO_ENTID'];
    ...
    const client = new __1.CityAutocompleteSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=CountryTranslationDtoDirect.test.js.map