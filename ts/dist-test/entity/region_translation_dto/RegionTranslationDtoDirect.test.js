...
(0, node_test_1.describe)('RegionTranslationDtoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-region_translation_dto', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-region_translation_dto', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["region_translation_dto01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CITY_AUTOCOMPLETE_TEST_REGION_TRANSLATION_DTO_ENTID'];
...
//# sourceMappingURL=RegionTranslationDtoDirect.test.js.map