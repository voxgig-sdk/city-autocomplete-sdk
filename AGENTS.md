# CityAutocomplete SDK — Agent Guide
...
**Entities** (11): `City`, `CityDto`, `CityTranslationDto`, `Country`, `CountryTranslationDto`, `Distance`, `Language`, `Oneshot`, `Region`, `RegionTranslationDto`, `SettlementType`.
