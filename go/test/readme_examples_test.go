...
const testSeed = `map[string]any{"entity": map[string]any{"city": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "city_dto": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "city_translation_dto": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "country": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "country_translation_dto": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "distance": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "language": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "oneshot": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "region": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "region_translation_dto": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "settlement_type": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
