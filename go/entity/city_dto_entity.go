...
func NewCityDtoEntity(client *core.CityAutocompleteSDK, entopts map[string]any) *CityDtoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CityDtoEntity) GetName() string { return e.name }
...
func (e *CityDtoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CityDtoEntity) Deleted() bool {
	return e.deleted
}


func (e *CityDtoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCityDtoEntity(e.client, opts)
}

func (e *CityDtoEntity) Data(args ...any) any {
...
func (e *CityDtoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CityDto; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CityDtoEntity) DataTyped(data ...CityDto) CityDto {
	if len(data) > 0 {
		return typedFrom[CityDto](e.Data(asMap(data[0])))
	}
	return typedFrom[CityDto](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CityDto (all fields
// optional at the wire level).
func (e *CityDtoEntity) MatchTyped(match ...CityDto) CityDto {
	if len(match) > 0 {
		return typedFrom[CityDto](e.Match(asMap(match[0])))
	}
	return typedFrom[CityDto](e.Match())
}
...
func (e *CityDtoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CityDtoEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CityDtoEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CityDtoListMatch and returns []CityDto. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CityDtoEntity) ListTyped(reqmatch CityDtoListMatch, ctrl map[string]any) ([]CityDto, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[CityDto](res), nil
}



func (e *CityDtoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CityDtoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CityDtoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CityDtoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
