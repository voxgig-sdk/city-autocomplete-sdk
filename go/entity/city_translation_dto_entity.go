...
type CityTranslationDtoEntity struct {
	name    string
...
func NewCityTranslationDtoEntity(client *core.CityAutocompleteSDK, entopts map[string]any) *CityTranslationDtoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CityTranslationDtoEntity) GetName() string { return e.name }
...
func (e *CityTranslationDtoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CityTranslationDtoEntity) Deleted() bool {
	return e.deleted
}


func (e *CityTranslationDtoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCityTranslationDtoEntity(e.client, opts)
}

func (e *CityTranslationDtoEntity) Data(args ...any) any {
...
func (e *CityTranslationDtoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CityTranslationDto; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CityTranslationDtoEntity) DataTyped(data ...CityTranslationDto) CityTranslationDto {
	if len(data) > 0 {
		return typedFrom[CityTranslationDto](e.Data(asMap(data[0])))
	}
	return typedFrom[CityTranslationDto](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CityTranslationDto (all fields
// optional at the wire level).
func (e *CityTranslationDtoEntity) MatchTyped(match ...CityTranslationDto) CityTranslationDto {
	if len(match) > 0 {
		return typedFrom[CityTranslationDto](e.Match(asMap(match[0])))
	}
	return typedFrom[CityTranslationDto](e.Match())
}
...
func (e *CityTranslationDtoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CityTranslationDtoEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CityTranslationDtoEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CityTranslationDtoListMatch and returns []CityTranslationDto. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CityTranslationDtoEntity) ListTyped(reqmatch CityTranslationDtoListMatch, ctrl map[string]any) ([]CityTranslationDto, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[CityTranslationDto](res), nil
}



func (e *CityTranslationDtoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CityTranslationDtoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CityTranslationDtoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CityTranslationDtoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
