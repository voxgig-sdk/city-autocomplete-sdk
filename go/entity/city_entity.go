...
func NewCityEntity(client *core.CityAutocompleteSDK, entopts map[string]any) *CityEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CityEntity) List(_ map[string]any, _ map[string]any) (any, error) {
