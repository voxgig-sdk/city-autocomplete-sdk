...
func NewOneshotEntity(client *core.CityAutocompleteSDK, entopts map[string]any) *OneshotEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OneshotEntity) GetName() string { return e.name }
...
func (e *OneshotEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OneshotEntity) Deleted() bool {
	return e.deleted
}


func (e *OneshotEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOneshotEntity(e.client, opts)
}

func (e *OneshotEntity) Data(args ...any) any {
...
func (e *OneshotEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Oneshot; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OneshotEntity) DataTyped(data ...Oneshot) Oneshot {
	if len(data) > 0 {
		return typedFrom[Oneshot](e.Data(asMap(data[0])))
	}
	return typedFrom[Oneshot](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Oneshot (all fields
// optional at the wire level).
func (e *OneshotEntity) MatchTyped(match ...Oneshot) Oneshot {
	if len(match) > 0 {
		return typedFrom[Oneshot](e.Match(asMap(match[0])))
	}
	return typedFrom[Oneshot](e.Match())
}
...
func (e *OneshotEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OneshotEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *OneshotEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OneshotListMatch and returns []Oneshot. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *OneshotEntity) ListTyped(reqmatch OneshotListMatch, ctrl map[string]any) ([]Oneshot, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Oneshot](res), nil
}



func (e *OneshotEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *OneshotEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OneshotEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OneshotEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
