...
func NewDistanceEntity(client *core.CityAutocompleteSDK, entopts map[string]any) *DistanceEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DistanceEntity) GetName() string { return e.name }
...
func (e *DistanceEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DistanceEntity) Deleted() bool {
	return e.deleted
}


func (e *DistanceEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDistanceEntity(e.client, opts)
}

func (e *DistanceEntity) Data(args ...any) any {
...
func (e *DistanceEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Distance; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DistanceEntity) DataTyped(data ...Distance) Distance {
	if len(data) > 0 {
		return typedFrom[Distance](e.Data(asMap(data[0])))
	}
	return typedFrom[Distance](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Distance (all fields
// optional at the wire level).
func (e *DistanceEntity) MatchTyped(match ...Distance) Distance {
	if len(match) > 0 {
		return typedFrom[Distance](e.Match(asMap(match[0])))
	}
	return typedFrom[Distance](e.Match())
}
...
func (e *DistanceEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DistanceEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DistanceLoadMatch and returns an Distance. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DistanceEntity) LoadTyped(reqmatch DistanceLoadMatch, ctrl map[string]any) (Distance, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Distance{}, err
	}
	return typedFrom[Distance](res), nil
}



func (e *DistanceEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DistanceEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DistanceEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DistanceEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DistanceEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
