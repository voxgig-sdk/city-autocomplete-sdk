...
type SettlementTypeEntity struct {
	name    string
...
func NewSettlementTypeEntity(client *core.CityAutocompleteSDK, entopts map[string]any) *SettlementTypeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SettlementTypeEntity) GetName() string { return e.name }
...
func (e *SettlementTypeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SettlementTypeEntity) Deleted() bool {
	return e.deleted
}


func (e *SettlementTypeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSettlementTypeEntity(e.client, opts)
}

func (e *SettlementTypeEntity) Data(args ...any) any {
...
func (e *SettlementTypeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an SettlementType; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SettlementTypeEntity) DataTyped(data ...SettlementType) SettlementType {
	if len(data) > 0 {
		return typedFrom[SettlementType](e.Data(asMap(data[0])))
	}
	return typedFrom[SettlementType](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through SettlementType (all fields
// optional at the wire level).
func (e *SettlementTypeEntity) MatchTyped(match ...SettlementType) SettlementType {
	if len(match) > 0 {
		return typedFrom[SettlementType](e.Match(asMap(match[0])))
	}
	return typedFrom[SettlementType](e.Match())
}
...
func (e *SettlementTypeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SettlementTypeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *SettlementTypeEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SettlementTypeListMatch and returns []SettlementType. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *SettlementTypeEntity) ListTyped(reqmatch SettlementTypeListMatch, ctrl map[string]any) ([]SettlementType, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[SettlementType](res), nil
}



func (e *SettlementTypeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SettlementTypeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SettlementTypeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SettlementTypeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
